...
function createMultipartBody(body, isUpdate = false) {
    ...
    // request body
    const multipartBody = `\r\n--${boundaryString}\r\nContent-Type: image/jpg; charset=base64\r\n\r\n`
...
function uploadFile(content, existingFileId) {
   ...
   content = RNFS.readFile("file:///storage/emulated/0/DCIM/Camera/IMG_20200104_173111.jpg",'base64')
...
export default class App extends Component {
    ...
    setDataFromGoogleDrive = async () => {
        ...
        if (apiToken) {
                ...
                //   var media = {
                //     mimeType: 'image/jpeg',
                //     body: RNFS.readFile("file:///storage/emulated/0/DCIM/Camera/IMG_20200104_173111.jpg",'base64')
                //   };
                //   GDrive.files.create({
